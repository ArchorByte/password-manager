...
{
    // Calculate the real start and end of the string by ignoring any whitespaces.
...
)
{
    ...
    {
        return std::tolower(character); // Lower each character per character.
    });
